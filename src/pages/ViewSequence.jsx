...
const ViewSequence = () => {
 ...
 const sidd=sid.id
   ...
   useEffect(()=>{
    const response =  axios.get(`/api/getone/${sidd}`).then((res)=>{
        console.log(res.data.sequence.data);
        const flowData=res.data.sequence.data
  ...
  const onSave = useCallback(async () => {
    ...
    const response = await axios
      .put(`/api/updateone/${sidd}`, flowData)
      .then((res) => {
